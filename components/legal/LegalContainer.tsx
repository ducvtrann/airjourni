    ...
    <Container maxWidth="xl">
      ...
      <Box sx={{ borderTop: 1, borderColor: 'primary.main', my: 2, pt: 2 }}>
        ...
        <Typography variant="h6" gutterBottom fontWeight={'bold'}>
          Agreement between User and https://www.airjourni.com
        </Typography>
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          Welcome to https://www.airjourni.com. The https://www.airjourni.com
          website (the "Site") is comprised of various web pages operated by
          AirJourni LLC ("AirJourni"). The Site is a travel planner and aims to
          help travelers plan for their next trip. The Site is offered to you
          conditioned on your acceptance without modification of the terms,
          conditions, and notices contained herein (the "Terms"). Please read
        ...
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          Your use of the Site is subject to AirJourni's Privacy Policy. Please
        ...
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          Visiting the Site or sending emails to AirJourni constitutes
        ...
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          For the purposes of these Terms and Conditions, unless otherwise
          noted, all references to “your account” mean / include your right to
          access and to use this site and your usage of this site. If you use
          this site, you are responsible for maintaining the confidentiality of
          your account and for restricting access to your computer, and you
          agree to accept responsibility for all activities that occur under
          your account. You may not assign or otherwise transfer your account to
          any other person or entity, and you may not share an account with
          another person. You acknowledge that AirJourni is not responsible for
          third party access to your account that results from theft or
          misappropriation of your account. AirJourni reserves the right to
        ...
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          AirJourni does not knowingly collect, either online or offline,
        ...
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          ...
          Linked Sites are not under the control of AirJourni and AirJourni is
          ...
          updates to a Linked Site. AirJourni is providing these links to you
          only as a convenience, and the inclusion of any link does not imply
          endorsement by AirJourni of the site or any association with its
          operators. Certain services may be made available via the Site and
          delivered by third party sites and organizations. By using any
          product, service or functionality originating from the
          https://www.airjourni.comdomain, you hereby acknowledge and consent
          that AirJourni may share such information and data with any third
          party with whom AirJourni has a contractual relationship to provide
          the requested product, service or functionality on behalf of the
          Site's users and customers.
        </Typography>
        <Typography variant="h6" gutterBottom fontWeight={'bold'}>
        ...
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          ...
          use. As a condition of your use of the Site, you warrant to AirJourni
          ...
          any software used on the Site, is the property of AirJourni or its
          ...
          found on the Site. AirJourni content is not for resale. Your use of
          ...
          use of the content without the express written permission of AirJourni
          and the copyright owner. You will not record, upload, or stream videos
          of yourself using any part of the content and/or of the platform that
          requires purchasing in order to be accessed. You agree that you do not
          ...
          AirJourni or our licensors except as expressly authorized by these
          Terms. Use of Communication Services The Site may contain bulletin
          board services, chat areas, news groups, forums, communities, personal
          web pages, calendars, and/or other message or communication facilities
          ...
          damage the operation of another's computer; advertise or offer to sell
          ...
          forward surveys, contests, pyramid schemes or chain letters; download
          any file posted by another user of a Communication Service that you
          ...
          uploaded; restrict or inhibit any other user from using and enjoying
          the Communication Services; violate any code of conduct or other
          ...
          including email addresses, without their consent; violate any
          applicable laws or regulations. AirJourni has no obligation to monitor
          the Communication Services. However, AirJourni reserves the right to
          review materials posted to a Communication Service and to remove any
          materials in its sole discretion. AirJourni reserves the right to
          terminate your access to any or all of the Communication Services at
          any time without notice for any reason whatsoever. AirJourni reserves
          ...
          materials, in whole or in part, in AirJourni's sole discretion. Always
          ...
          AirJourni does not control or endorse the content, messages or
          information found in any Communication Service and, therefore,
          AirJourni specifically disclaims any liability with regard to the
          ...
          authorized AirJourni spokespersons, and their views do not necessarily
          reflect those of AirJourni. Materials uploaded to a Communication
        ...
        <Typography variant="h6" gutterBottom fontWeight={'bold'}>
          Materials Provided to the Site or Posted on Any AirJourni Web Page
        </Typography>
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          AirJourni does not claim ownership of the materials you provide to the
          Site (including feedback and suggestions) or post, upload, input or
          submit to the AirJourni Site (collectively "Submissions"). However, by
          posting, uploading, inputting, providing or submitting your Submission
          you are granting AirJourni permission to use your Submission in
          connection with the operation of its Internet businesses including,
          ...
          of your Submission, as provided herein. AirJourni is under no
          obligation to post or use any Submission you may provide and may
          remove any Submission at any time in AirJourni's sole discretion. By
          posting, uploading, inputting, providing or submitting your Submission
        ...
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          The Service is controlled, operated and administered by AirJourni from
          ...
          laws. You agree that you will not use the AirJourni Content accessed
          through the Site in any country or in any manner prohibited by any
        ...
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          You agree to indemnify, defend and hold harmless AirJourni, its
          ...
          rules or regulations. AirJourni reserves the right, at its own cost,
          ...
          cooperate with AirJourni in asserting any available defenses.
        </Typography>
        <Typography variant="h6" gutterBottom fontWeight={'bold'}>
          Liability Disclaimer
        </Typography>
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          AirJourni LLC IS AN INDEPENDENT COMPANY. AirJourni DOES NOT REPRESENT
          AND IS NOT AFFILIATED WITH ITS FOUNDERS’ EMPLOYERS OR ANY OTHER
          COMPANY, ORGANIZATION OR ASSOCIATION IN ANY WAY WHATSOEVER. THE
          ...
          CHANGES ARE PERIODICALLY ADDED TO THE INFORMATION HEREIN. AirJourni
          LLC AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES IN THE
          SITE AT ANY TIME. AirJourni LLC AND/OR ITS SUPPLIERS MAKE NO
          ...
          PROVIDED "AS IS" WITHOUT WARRANTY OR CONDITION OF ANY KIND. AirJourni
          LLC AND/OR ITS SUPPLIERS HEREBY DISCLAIM ALL WARRANTIES AND CONDITIONS
          ...
          IN NO EVENT SHALL AirJourni LLC AND/OR ITS SUPPLIERS BE LIABLE FOR ANY
          ...
          NEGLIGENCE, STRICT LIABILITY OR OTHERWISE, EVEN IF AirJourni LLC OR
        ...
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          AirJourni reserves the right, in its sole discretion, to terminate
        ...
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          ...
          the laws of the State of Georgia and you hereby consent to the
          exclusive jurisdiction and venue of courts in Georgia in all disputes
        ...
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          ...
          relationship exists between you and AirJourni as a result of this
          agreement or use of the Site. AirJourni's performance of this
          agreement is subject to existing laws and legal process, and nothing
          contained in this agreement is in derogation of AirJourni's right to
          ...
          to or gathered by AirJourni with respect to such use. If any part of
          ...
          constitutes the entire agreement between the user and AirJourni with
          ...
          between the user and AirJourni with respect to the Site. A printed
        ...
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          AirJourni reserves the right, in its sole discretion, to change the
          Terms under which the Site is offered. The most current version of the
          Terms will supersede all previous versions. AirJourni encourages you
        ...
        <Typography variant="body1" color={'text.secondary'} gutterBottom>
          AirJourni welcomes your questions or comments regarding the Terms. You
          may address your questions or comments to AirJourni LLC by clicking
          the Contact Us button at the bottom of our home page on the website.
        </Typography>
      </Box>
      <Footer />
    </Container>
