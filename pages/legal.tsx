...
const Legal: NextPage = () => {
  return (
    <>
      ...
      <BaseContainer>
        <section className="">
          <h2 className="max-w-2xl mt-3 mb-4 text-3xl font-bold leading-snug tracking-tight text-gray-800 lg:leading-tight lg:text-4xl dark:text-white">
          ...
          <p className="mt-1 mb-4 text-gray-500 dark:text-gray-400">
            ...
            AirJourni LLC ("AirJourni"). The Site is a travel planner and aims
            to help travelers plan for their next trip. The Site is offered to
            ...
            reference. All purchases are final and non-refundable.
          </p>
          <h4 className="text-xl font-medium text-gray-800 dark:text-gray-200">
            Privacy
          </h4>
          <p className="mt-1 mb-4 text-gray-500 dark:text-gray-400">
            Your use of the Site is subject to AirJourni's Privacy Policy.
          ...
          <p className="mt-1 mb-4 text-gray-500 dark:text-gray-400">
            ...
            of your account and for restricting access to your computer, and you
            agree to accept responsibility for all activities that occur under
            your account. You may not assign or otherwise transfer your account
            to any other person or entity, and you may not share an account with
            another person. You acknowledge that AirJourni is not responsible
          ...
          <p className="mt-1 mb-4 text-gray-500 dark:text-gray-400">
            ...
            changes or updates to a Linked Site. AirJourni is providing these
            links to you only as a convenience, and the inclusion of any link
            does not imply endorsement by AirJourni of the site or any
            ...
            originating from the https://www.airjourni.comdomain, you hereby
            acknowledge and consent that AirJourni may share such information
            and data with any third party with whom AirJourni has a contractual
            relationship to provide the requested product, service or
            functionality on behalf of the Site's users and customers.
          </p>
          <h4 className="text-xl font-medium text-gray-800 dark:text-gray-200">
          ...
          <p className="mt-1 mb-4 text-gray-500 dark:text-gray-400">
            ...
            to access and use the Site strictly in accordance with these terms
            of use. As a condition of your use of the Site, you warrant to
            AirJourni that you will not use the Site for any purpose that is
            ...
            property of AirJourni or its suppliers and protected by copyright
            ...
            of the content, in whole or in part, found on the Site. AirJourni
            ...
            content without the express written permission of AirJourni and the
            copyright owner. You will not record, upload, or stream videos of
            yourself using any part of the content and/or of the platform that
            requires purchasing in order to be accessed. You agree that you do
            ...
            property of AirJourni or our licensors except as expressly
            authorized by these Terms. Use of Communication Services The Site
            ...
            regulations. AirJourni has no obligation to monitor the
            Communication Services. However, AirJourni reserves the right to
            ...
            any time without notice for any reason whatsoever. AirJourni
            ...
            information or materials, in whole or in part, in AirJourni's sole
            discretion. Always use caution when giving out any personally
            identifying information about yourself or your children in any
            Communication Service. AirJourni does not control or endorse the
            content, messages or information found in any Communication Service
            and, therefore, AirJourni specifically disclaims any liability with
            ...
            are not authorized AirJourni spokespersons, and their views do not
            necessarily reflect those of AirJourni. Materials uploaded to a
          ...
          <p className="mt-1 mb-4 text-gray-500 dark:text-gray-400">
            AirJourni does not claim ownership of the materials you provide to
            the Site (including feedback and suggestions) or post, upload, input
            or submit to the AirJourni Site (collectively "Submissions").
            However, by posting, uploading, inputting, providing or submitting
            your Submission you are granting AirJourni permission to use your
            Submission in connection with the operation of its Internet
            ...
            name in connection with your Submission. No compensation will be
            paid with respect to the use of your Submission, as provided herein.
            AirJourni is under no obligation to post or use any Submission you
            may provide and may remove any Submission at any time in AirJourni's
            sole discretion. By posting, uploading, inputting, providing or
            submitting your Submission you warrant and represent that you own or
            otherwise control all of the rights to your Submission as described
            in this section including, without limitation, all the rights
          ...
          <p className="mt-1 mb-4 text-gray-500 dark:text-gray-400">
            The Service is controlled, operated and administered by AirJourni
            ...
            all local laws. You agree that you will not use the AirJourni
          ...
          <p className="mt-1 mb-4 text-gray-500 dark:text-gray-400">
            ...
            laws, rules or regulations. AirJourni reserves the right, at its own
            ...
            fully cooperate with AirJourni in asserting any available defenses.
          </p>
          <h4 className="text-xl font-medium text-gray-800 dark:text-gray-200">
            Liability Disclaimer
          </h4>
          <p className="mt-1 mb-4 text-gray-500 dark:text-gray-400">
            AirJourni LLC IS AN INDEPENDENT COMPANY. AirJourni DOES NOT
            REPRESENT AND IS NOT AFFILIATED WITH ITS FOUNDERS’ EMPLOYERS OR ANY
            OTHER COMPANY, ORGANIZATION OR ASSOCIATION IN ANY WAY WHATSOEVER.
            ...
            AirJourni LLC AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR
            CHANGES IN THE SITE AT ANY TIME. AirJourni LLC AND/OR ITS SUPPLIERS
            ...
            AirJourni LLC AND/OR ITS SUPPLIERS HEREBY DISCLAIM ALL WARRANTIES
            ...
            APPLICABLE LAW, IN NO EVENT SHALL AirJourni LLC AND/OR ITS SUPPLIERS
            ...
            EVEN IF AirJourni LLC OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF
            THE POSSIBILITY OF DAMAGES. IF YOU ARE DISSATISFIED WITH ANY PORTION
          ...
          <p className="mt-1 mb-4 text-gray-500 dark:text-gray-400">
            ...
            by the laws of the State of Georgia and you hereby consent to the
          ...
          <p className="mt-1 mb-4 text-gray-500 dark:text-gray-400">
            ...
            provided to or gathered by AirJourni with respect to such use. If
            ...
            user and AirJourni with respect to the Site and it supersedes all
            prior or contemporaneous communications and proposals, whether
            electronic, oral or written, between the user and AirJourni with
          ...
          <p className="mt-1 mb-4 text-gray-500 dark:text-gray-400">
            ...
            Terms under which the Site is offered. The most current version of
            the Terms will supersede all previous versions. AirJourni encourages
          ...
          <p className="mt-1 mb-4 text-gray-500 dark:text-gray-400">
            AirJourni welcomes your questions or comments regarding the Terms.
            You may address your questions or comments to AirJourni LLC by
            clicking the Contact Us button at the bottom of our home page on the
            website.
          </p>
        </section>
      </BaseContainer>
